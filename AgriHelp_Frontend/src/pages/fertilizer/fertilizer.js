...
const Fertilizer = () => {
  ...
  function onSearchSubmit(term) {
    setLoad(true);
    console.log("Clicked");
    let url = "http://127.0.0.1:8000/fertilizer-predict";
            ...
            <div className="flex flex-row my-2 w-3/5">
              ...
              <div className="ml-16 ">
                <select
                  ...
                  className="border-2 border-lime-600 p-2 rounded-sm w-64"
                >
            ...
            <div className="grid place-items-center mt-14 ">
              <div className="mt-2">
                <button
                  ...
                  type="button"
                  className="inline-block  px-6 py-2.5 bg-lime-600 text-white font-medium text-xs 
