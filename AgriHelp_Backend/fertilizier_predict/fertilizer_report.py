...
def generate_fertilizer_report(index, lang):
    ...
    application_1 = application.get("1", "")  # Get value for key "1", or empty string if key doesn't exist
    application_2 = application.get("2", "")  # Get value for key "2", or empty string if key doesn't exist
