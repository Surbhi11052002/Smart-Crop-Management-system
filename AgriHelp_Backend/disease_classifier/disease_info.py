...
def get_disease_recommendation(index, lang):
    print("index",index)
    return {
        "disease_name": main_dic[index]["disease_name"],
        "causes":{
            "1": main_dic[index]["causes"]["1"], 
            "2": main_dic[index]["causes"]["2"],
        },
        "prevent":{
            "1": main_dic[index]["prevent"]["1"], 
            "2": main_dic[index]["prevent"]["2"], 
            "3": main_dic[index]["prevent"]["3"], 
        },
    }
